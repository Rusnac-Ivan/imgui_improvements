...
typedef int ImGuiColGrad;               // -> enum ImGuiCol_             // Enum: A color identifier for styling
...
namespace ImGui
{
    ...
    IMGUI_API void          PushStyleColor(ImGuiColGrad idx, ImU32 col);                        // modify a style color. always use this if you modify the style after NewFrame().
    IMGUI_API void          PushStyleColor(ImGuiColGrad idx, const ImVec4& col);
    ...
    IMGUI_API ImU32         GetColorU32(ImGuiColGrad idx, float alpha_mul = 1.0f);              // retrieve given style color with style alpha applied and optional extra alpha multiplier, packed as a 32-bit value suitable for ImDrawList
    IMGUI_API ImU32         GetColorU32(const ImVec4& col);                                 // retrieve given color with style alpha applied, packed as a 32-bit value suitable for ImDrawList
    IMGUI_API ImU32         GetColorU32(ImU32 col);                                         // retrieve given color with style alpha applied, packed as a 32-bit value suitable for ImDrawList
    IMGUI_API const ImVec4& GetStyleColorVec4(ImGuiColGrad idx);                                // retrieve style color as stored in ImGuiStyle structure. use to feed back into PushStyleColor(), otherwise use GetColorU32() to get style color with style alpha baked in.
    ...
    IMGUI_API const char*   GetStyleColorName(ImGuiColGrad idx);                                    // get a string corresponding to the enum value (for display, saving, etc.).
...
struct ImGuiStyle
{
    ...
    ImVec4      Colors[ImGuiColGrad_COUNT];
